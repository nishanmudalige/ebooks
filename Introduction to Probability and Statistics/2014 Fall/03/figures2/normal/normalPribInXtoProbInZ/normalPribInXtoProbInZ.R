myPDF("normalPribInXtoProbInZ.pdf", 6.0, 1.75, mar=c(1.2,0,1.5,0), mgp=c(3,0.17,0))

layout(matrix(1:3, 1), widths=c(5,1.25,5), 1)
...
plot(sfx*X, sfy*Y, type='l', axes=F, 
     ...
     xlim=sfx*c(-3.4,3.4),
     ylab="", xlab="X",
     main="Problem in X", cex=1.2)


axis(1, at=c(-3,-2,-1,0,1,2,3), 
     label=(1500+c(-3,-2,-1,0,1,2,3)*300), cex.axis=0.8)
...
polygon(sfx*cord.x, sfy*cord.y, col=COL[4+7*0])
...
plot( NULL, NULL, 
      ...
      ylab="",
      axes=F)
arrows(-2, 0, 2, 0, length=0.175)
text(0, 0.5, labels="Transform", cex=1.2)
