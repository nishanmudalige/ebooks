...
data(COL)
#pdf('netTime1000000SamplingDistribution.pdf', 6.5, 3.2)
...
plot(0, 0, type='n', xlim=c(88, 102), ylim=c(0, ymax), xlab='Sample mean', ylab='Frequency', axes=FALSE)
...
rect(m-s/100, 0, m+s/100, ymax, col='#00000044', border='#00000000')
rect(m-s, 0, m+s, ymax, col='#00000011', border='#00000000')
rect(m-2*s, 0, m+2*s, ymax, col='#00000011', border='#00000000')
rect(m-3*s, 0, m+3*s, ymax, col='#00000011', border='#00000000')
#histPlot(means, col=COL[1], breaks=50, add=TRUE)
#histPlot(means, col=COL[1], breaks=100, add=FALSE, probability = TRUE)
histPlot(means, col=COL[1], breaks=100, add=TRUE, probability = FALSE)
abline(h=0)
axis(1, at=c(90, 95, 100))
#axis(2, at=c(0, 50, 100))
axis(2, at=seq(0,ymax, ymax/10) )
